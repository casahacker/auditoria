...
const LEGAL_NOTES: Record<string, { orgao: string; base: string; efeito: string; match: string }> = {
  ...
  "tce-sp-apenados": { orgao: "Tribunal de Contas do Estado de São Paulo (TCE-SP)", base: "Lei 8.666/93 art. 87; Lei 10.520/02 art. 7º; Lei 14.133/21 — impedimento de licitar/contratar; relação publicada mensalmente no DOE-SP", efeito: "Impedido de licitar e contratar com a Administração Pública estadual de São Paulo (enquanto vigente).", match: "CNPJ exato (vigente) / histórico" },
